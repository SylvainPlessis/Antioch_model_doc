...
\index{kinetics!forward rate}
\index{forward rate|see{kinetics, forward rate}}
...
\index{kinetics model}
\index{chemical process}
...
\index{kinetics!backward rate}
\index{backward rate|see{kinetics, backward rate}}
